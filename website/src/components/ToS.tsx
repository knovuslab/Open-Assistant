    ...
    sections: [
      {
        number: "1.1",
        title: "",
        desc: `LAION e.V., Herman-Lange-Weg 26, 21035 Hamburg, Germany (hereinafter referred to as: "LAION") operates an online portal for the production of a machine learning model called ራስ | rasGPT using crowd-sourced data.`,
      },
      {
        number: "1.2",
        title: "",
